...
#+begin_src elisp
  ...
  (setopt elfin-session-file (expand-file-name "elfin-sessions"
                                               user-emacs-directory)
          elfin-default-volume 80
          elfin-volume-step 5
          elfin-replaygain 'album)

  (elfin-restore-sessions)

  ;; Optional: ListenBrainz scrobbling
  (require 'elfin-listenbrainz)
